...
const Reports: React.FC = () => {
    ...
    try {
      ...
      switch (selectedReport) {
        case 'daily-attendance':
          endpoint = '/reports/operational/daily-attendance';
          params = { date: filters.date };
          break;
        case 'weekly-punctuality':
          endpoint = '/reports/operational/weekly-punctuality';
          params = { startDate: filters.startDate, endDate: filters.endDate };
          break;
        case 'active-absences':
          endpoint = '/reports/operational/active-absences';
          params = { startDate: filters.startDate, endDate: filters.endDate };
          break;
        case 'payroll':
  ...
  const renderFilters = () => {
    const needsDate = ['daily-attendance'].includes(selectedReport);
    const needsDateRange = ['weekly-punctuality', 'active-absences', 'payroll', 'overtime', 'turnover', 'audit', 'by-department', 'incidents'].includes(selectedReport);
