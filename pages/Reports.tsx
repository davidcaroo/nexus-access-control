      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 border-b pb-4">
        <div className="md:col-span-4">
          <div className="flex flex-wrap gap-2">
            ...
            <Button
              variant={activeCategory === 'administrative' ? 'default' : 'outline'}
              onClick={() => {
...
{/* Sub-tabs de Reportes Administrativos */ }
{
  activeCategory === 'administrative' && (
    <div className="bg-white rounded-lg shadow-sm border p-4">
      ...
      <div className="text-center py-12 text-gray-500">
        <AlertCircle size={48} className="mx-auto mb-4 opacity-50" />
        <p className="font-medium mb-2">Reportes Administrativos en Desarrollo</p>
        <p className="text-sm">La interfaz para estos reportes estará disponible próximamente.</p>
        <p className="text-sm text-blue-600 mt-2">Backend ya implementado ✓</p>
      </div>
    </div>
  )
}
